...
export class EditUserAsset extends BaseAsset {
	public name = 'editUser';
	public id = ASSET_IDS.editUser;
	public fee = FEES.editUser;

	public schema = {
		$id: 'mapsmap/editUser-asset',
		title: 'EditUserAsset transaction asset for mapsmap module',
		type: 'object',
